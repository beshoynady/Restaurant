...
const createOrder = async (req, res) => {
    try {
        ...
        const {
            serial, orderNum, products, subTotal, salesTax, serviceTax, addition, discount, deliveryCost,
             total, table, user, createdBy, cashier, name, address, phone, waiter, deliveryMan, help, helpStatus,
              status, orderType, isActive, payment_status, paymentMethod, payment_date
        } = req.body;
