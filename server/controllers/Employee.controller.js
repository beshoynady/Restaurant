...
const updateEmployeeSchema = Joi.object({
  ...
  role: Joi.string()
    .valid("owner", "manager", "cashier", "waiter", "deliveryman", "chef")
    .optional(),
...
const getoneEmployee = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "An error occurred while fetching the employee", err });
  }
};
...
const getAllemployees = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "An error occurred while fetching employees", err });
  }
};
...
const deleteEmployee = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Employee deleted successfully", employeedeleted });
  } catch (error) {
    res
      .status(500)
      .json({
