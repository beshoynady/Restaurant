    ...
    Permissions: [
      {
        resource: {
          type: String,
          enum:['Employees', 'Attendance', 'Employee Transactions', 'Payroll', 'Cash Register', 'Cash Movement',
             'stock Item', 'stock Categories', 'stock Management', 'store', 'Orders', 'Tables', 'Table Reservations',
