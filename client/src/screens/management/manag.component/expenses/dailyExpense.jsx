...
const DailyExpense = () => {
  ...
  const{restaurantData, permissionsList,setStartDate, setEndDate, filterByDateRange, filterByTime,
    employeeLoginInfo, usertitle, formatDate, formatDateTime, setisLoadiog, EditPagination, startpagination,
  ...
  const handlecashRegister = (id) => {
    const cashRegister = AllcashRegisters ? AllcashRegisters.filter((cash) => cash.employee._id === id) : {};
  ...
  const deleteDailyExpense = async (e) => {
    ...
    try {
      ...
      if (cashMovementId) { // Ensure cashMovementId has a value before sending the request
        ...
        const deleteExpenseRecord = await axios.delete(`${apiUrl}/api/dailyexpense/${dailyexpenseId}`, config);
        const deleteCashMovement = await axios.delete(`${apiUrl}/api/cashMovement/${cashMovementId}`, config)
  ...
  const filterByExpenseType = (expenseType) => {
    ...
    const filterExpenseByType=allExpenses && allExpenses.filter(expense=> expense.expenseType === expenseType)
          ...
          <div className="table-title">
            <div className="d-flex flex-wrap align-items-center justify-content-between">
              ...
              <div className="col-12 col-md-6 p-0 m-0 d-flex flex-wrap aliegn-items-center  justify-content-evenly">
                <a href="#addDailyExpensesModal" className="d-flex align-items-center justify-content-center col-4 h-100 p-2 m-0 btn btn-success" data-toggle="modal" onClick={() => handlecashRegister(employeeLoginInfo.id)}> <span>اضافه مصروف جديد</span></a>

                {/* <a href="#deleteDailyExpensesModal" className="d-flex align-items-center justify-content-center col-4 h-100 p-2 m-0 btn btn-danger" data-toggle="modal"> <span>حذف</span></a> */}
              </div>
            </div>
          </div>
          <div className="table-filter print-hide">
            <div className="col-12 text-dark d-flex flex-wrap align-items-center justify-content-evenly p-0 m-0">
              ...
              <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                ...
                <input type="text" className="form-control border-primary" onChange={(e) => searchByDailyExpense(e.target.value)} />
              </div>

              <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                <label className="form-label text-wrap text-right fw-bolder p-0 m-0">المصروف</label>
                <select className="form-control border-primary" onChange={(e) => filterByExpense(e.target.value)}>
              ...
              <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                ...
                <select className="form-control border-primary" onChange={(e) => filterByExpenseType(e.target.value)}>
                  <option value="">اختر</option>
              ...
              <div className='col-12 d-flex align-items-center justify-content-between'>
                <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                  ...
                  <select className="form-control border-primary"  onChange={(e) => setallDailyExpenses(filterByTime(e.target.value, allDailyExpenses))}>
                    <option value="">اختر</option>
                ...
                <div className="d-flex align-items-center justify-content-between flex-nowrap col-9 p-0 m-0 px-1">
                  ...
                  <div className="d-flex flex-nowrap justify-content-between col-3 p-0 m-0">
                    ...
                    <button type="button" className=" btn btn-warning w-50 h-100 p-2" onClick={getallDailyExpenses}>استعادة
                    </button>
                  </div>
                </div>
              </div>
                    ...
                    <tr key={i}>
                      ...
                      <td>
                        <a href="#editDailyExpensesModal" className="edit" data-toggle="modal" onClick={() => {
                          ...
                          setcashMovementId(dailyexpense.cashMovementId?._id);
                          setexpenseId(dailyexpense.expenseId?._id);
                          setcashRegister(dailyexpense.cashRegister._id);
                          setcashRegisterName(dailyexpense.cashRegister?.name)
                          setexpenseDescription(dailyexpense.expenseDescription);
                        ...
                        <a href="#deleteDailyExpensesModal" className="delete" data-toggle="modal" onClick={() => {
                          setexpenseId(dailyexpense.expenseId?._id);
                          setcashRegister(dailyexpense.cashRegister._id);
                          setdailyexpenseId(dailyexpense._id);
                          setamount(dailyexpense.amount);
            ...
            <form onSubmit={createDailyExpense}>
              ...
              <div className="modal-body p-4 text-right">
                ...
                <div className="form-group col-12 col-md-6" >
                  ...
                  <input type="date" className="form-control border-primary" required onChange={(e) => {
                    setdate(e.target.value)
                  }} />
                </div>
                <div className="form-group col-12 col-md-6" >
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">المبلغ</label>
                  <input type="Number" className="form-control border-primary" required onChange={(e) => {
                    setamount(e.target.value)
                  }} />
                </div>
                <div className="form-group col-12 col-md-6" >
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الخزينه </label>
                  <select className="form-control border-primary"  onChange={(e) => selectCashRegister(e.target.value)} >
                ...
                <div className="form-group col-12 col-md-6">
                  ...
                  <textarea className="form-control border-primary" rows={2} cols={50} onChange={(e) => { setnotes(e.target.value) }} />
                </div>
              </div>
          ...
          <div className="modal-content shadow-lg border-0 rounded ">
            <form onSubmit={editDailyExpense}>
              ...
              <div className="modal-body p-4 text-right">
                ...
                <div className="form-group col-12 col-md-6" >
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">المبلغ</label>
                  <input type="Number" className="form-control border-primary" value={amount} required onChange={(e) => {
                    setamount(e.target.value)
                  }} />
                </div>
                <div className="form-group col-12 col-md-6" >
                ...
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">ملاحظات</label>
                  <textarea className="form-control border-primary" rows={2} cols={100} value={notes} onChange={(e) => { setnotes(e.target.value) }} />
                </div>
              </div>
              <div className="modal-footer d-flex flex-nowrap align-items-center justify-content-between m-0 p-1">
