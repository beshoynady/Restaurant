          ...
          <div className="table-filter print-hide">
            <div className="col-12 text-dark d-flex flex-wrap align-items-center justify-content-evenly p-0 m-0">
              ...
              <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                ...
                <input type="text" className="form-control border-primary" onChange={(e) => searchByExpense(e.target.value)} />
              </div>
            ...
            <form onSubmit={createExpense}>
              ...
              <div className="modal-body p-4 text-right">
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">اسم المصروف</label>
                  <input type="text" className="form-control border-primary" required onChange={(e) => setDescription(e.target.value)} />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">نوع المصروف</label>
                  <select
          ...
          <div className="modal-content shadow-lg border-0 rounded ">
            <form onSubmit={editExpense}>
              ...
              <div className="modal-body p-4 text-right">
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">اسم المصروف</label>
                  <input type="text" className="form-control border-primary" defaultValue={description} required onChange={(e) => setDescription(e.target.value)} />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">نوع المصروف</label>
                  <select
