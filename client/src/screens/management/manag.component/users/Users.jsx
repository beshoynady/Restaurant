          ...
          <div class="table-filter print-hide">
            <div className="w-100 d-flex flex-row flex-wrap align-items-center justify-content-start text-dark">
              ...
              <div class="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                ...
                <input type="text" class="form-control border-primary m-0 h-100 " onChange={(e) => getUserByPhone(e.target.value)} />
              ...
              <div className='col-12 d-flex align-items-center justify-content-between'>
                <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                  ...
                  <select className="form-control border-primary m-0 h-100 "  onChange={(e) => setAllUsers(filterByTime(e.target.value, AllUsers))}>
                  ...
                  if (i >= startpagination & i < endpagination) {
                    return (
                      <tr key={i}>
                        ...
                        <td>{user.email}</td>
                        <td>
                          <select className="form-control border-primary m-0 h-100 "  name="status" id="status" form="carform" onChange={(e) => { changeorderActive(e, user._id) }}>
                        ...
                        <td>
                          <select className="form-control border-primary m-0 h-100 "  name="status" id="status" form="carform" onChange={(e) => { changeorderVarified(e, user._id) }}>
                    ...
                    <form onSubmit={createuserloyee}>
                      ...
                      <div className="modal-body p-4 text-right">
                        <div className="form-group col-12 col-md-6">
                          ...
                          <input type="text" className="form-control border-primary m-0 h-100 " required pattern="[A-Za-z\u0600-\u06FF\s]+" onChange={(e) => setusername(e.target.value)} />
                          <div className="invalid-feedback">Please enter a valid name.</div>
                        </div>
                        <div className="form-group col-12 col-md-6">
                          <label className="form-label text-wrap text-right fw-bolder p-0 m-0">اسم المستخدم</label>
                          <input type="text" className="form-control border-primary m-0 h-100 " required onChange={(e) => setusername(e.target.value)} />
                        </div>
                        <div className="form-group col-12 col-md-6">
                          <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الموبايل</label>
                          <input type="text" className="form-control border-primary m-0 h-100 " required pattern="[0-9]{11}" onChange={(e) => setphone(e.target.value)} />
                        ...
                        <div className="form-group col-12 col-md-6">
                          ...
                          <input type="text" className="form-control border-primary m-0 h-100 " required onChange={(e) => setpassword(e.target.value)} />
                        </div>
                        <div className="form-group col-12 col-md-6">
                          <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الرقم القومي</label>
                          <input type="text" className="form-control border-primary m-0 h-100 " required onChange={(e) => setnumberID(e.target.value)} />
                        </div>
                        <div className="form-group col-12 col-md-6">
                          <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الايميل</label>
                          <input type="email" className="form-control border-primary m-0 h-100 " required onChange={(e) => setemail(e.target.value)} />
                          <div className="invalid-feedback">Please enter a valid email address.</div>
                        </div>
                        <div className="form-group col-12 col-md-6">
                          <label className="form-label text-wrap text-right fw-bolder p-0 m-0">العنوان</label>
                          <textarea className="form-control border-primary m-0 h-100 " required onChange={(e) => setaddress(e.target.value)}></textarea>
                        </div>
                        <div className="form-group col-12 col-md-6">
                          <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الحالة</label>
                          <select className="form-control border-primary m-0 h-100 " form="carform" required onChange={(e) => setisActive(e.target.value)}>
                            <option value="">اختر</option>
                        ...
                        <div className="form-group col-12 col-md-6">
                          ...
                          <select className="form-control border-primary m-0 h-100 "  name={role} form="carform" required onChange={(e) => setrole(e.target.value)}>
                        ...
                        <div className="form-group col-12 col-md-6">
                          ...
                          <input type="Number" min={0} className="form-control border-primary m-0 h-100 " required onChange={(e) => setbasicSalary(e.target.value)} />
