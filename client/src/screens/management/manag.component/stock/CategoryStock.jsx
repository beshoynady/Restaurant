          ...
          <div className="table-filter print-hide">
            <div className="col-12 text-dark d-flex flex-wrap align-items-center justify-content-evenly p-0 m-0">
              ...
              <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                ...
                <input type="text" className="form-control border-primary m-0 h-100 " onChange={(e) => searchByCategoryStock(e.target.value)} />
              </div>
            </div>
          </div>
            ...
            <form onSubmit={createCategoryStock}>
              ...
              <div className="modal-body p-4 text-right">
                <div className="form-group w-100 h-auto px-3 d-flex align-itmes-center justify-content-start col-12 ">
                  ...
                  <input type="text" className="form-control border-primary m-0 h-100 " required onChange={(e) => setcategoryStockname(e.target.value)} />
                </div>
              </div>
