          ...
          <div class="table-filter w-100 p-0 print-hide">
            <div className="w-100 d-flex flex-row flex-wrap align-items-center justify-content-evenly text-dark">
              ...
              <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                ...
                <input id="dateInput"
                  type="date"
                  value={date} class="form-control border-primary" onChange={handleDateChange} />
              </div>

              <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                <label className="form-label text-wrap text-right fw-bolder p-0 m-0">اسم الصنف</label>
                <input type="text" class="form-control border-primary" onChange={(e) => searchByKitchenConsumption(e.target.value)} />
              </div>

              <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                <label className="form-label text-wrap text-right fw-bolder p-0 m-0">اختر الصنف</label>
                <select class="form-control border-primary" onChange={(e) => searchByKitchenConsumption(e.target.value)} >
              ...
              <div className='col-12 d-flex align-items-center justify-content-between'>
                <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                  ...
                  <select className="form-control border-primary"  onChange={(e) => setAllKitchenConsumption(filterByTime(e.target.value, allKitchenConsumption))}>
            ...
            <form onSubmit={(e) => addKitchenItem(e)}>
              ...
              <div className="modal-body p-4 text-right">
                ...
                <div className="form-group col-12 col-md-6">
                  ...
                  <input type='Number' className="form-control border-primary" required onChange={(e) => setquantityTransferredToKitchen(Number(e.target.value))} />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الوحدة </label>
                  <input type='text' className="form-control border-primary" required defaultValue={unit}></input>
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">التاريخ</label>
                  <input type='text' className="form-control border-primary" Value={formatDateTime(new Date())} required readOnly />
                </div>
              </div>
          ...
          <div className="modal-content shadow-lg border-0 rounded ">
            <form onSubmit={(e) => updateKitchenItem(e)}>
              ...
              <div className="modal-body p-4 text-right">
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">اسم الصنف</label>
                  <input type="text" className="form-control border-primary" defaultValue={stockItemName} required />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الكمية المستلمة</label>
                  <input type="text" className="form-control border-primary" defaultValue={quantityTransferredToKitchen} required readOnly />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الكمية المستهلكه</label>
                  <input type="text" className="form-control border-primary" defaultValue={consumptionQuantity} required readOnly />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الرصيد الدفتري</label>
                  <input type="text" className="form-control border-primary" defaultValue={bookBalance} required readOnly />
                </div>
                <div className="form-group col-12 col-md-6">
                ...
                <div className="form-group col-12 col-md-6">
                  ...
                  <input type="text" className="form-control border-primary" defaultValue={adjustment} required readOnly />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الوحدة </label>
                  <input type='text' className="form-control border-primary" defaultValue={unit} required></input>
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">التاريخ</label>
                  <input type='text' className="form-control border-primary" defaultValue={formatDateTime(new Date())} required readOnly />
                </div>
              </div>
              <div className="modal-footer d-flex flex-nowrap align-items-center justify-content-between m-0 p-1">
