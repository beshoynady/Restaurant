          ...
          <div class="table-filter print-hide">
            <div class="col-12 text-dark d-flex flex-wrap align-items-center justify-content-evenly p-0 m-0">
              ...
              <div class="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                ...
                <input type="text" class="form-control border-primary" onChange={(e) => searchByitem(e.target.value)} />
              </div>
              <div class="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                <label className="form-label text-wrap text-right fw-bolder p-0 m-0">نوع الاوردر</label>
                <select class="form-control border-primary" onChange={(e) => searchByaction(e.target.value)} >
              ...
              <div className='col-12 d-flex align-items-center justify-content-between'>
                <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                  ...
                  <select className="form-control border-primary" onChange={(e) => setAllStockactions(filterByTime(e.target.value, AllStockactions))}>
            ...
            <form onSubmit={(e) => createStockAction(e, employeeLoginInfo.id)}>
              ...
              <div className="modal-body p-4 text-right">
                <div className="form-group col-12 col-md-6">
                  ...
                  <select className="form-control border-primary" name="" id="" onChange={(e) => setmovement(e.target.value)}>
                ...
                <div className="form-group col-12 col-md-6">
                  ...
                  <select className="form-control border-primary" name="" id="" onChange={(e) => { handleSelectedItem(e) }}>
                ...
                <div className="form-group col-12 col-md-6">
                  ...
                  {["Issuance", "ReturnIssuance", "Wastage", "Damaged"].includes(movement) ? (
                    ...
                    <input type="text" className="form-control border-primary" readOnly value="0" />
                  )}
                </div>
                ...
                <>
                            <div className="form-group col-12 col-md-6">
                              ...
                              {expirationDateEnabled &&
                                <input type='date' className="form-control border-primary" required onChange={(e) => { setexpirationDate(e.target.value); }} />}
                            </div>
                          </>
                        } */}
                ...
                <div className="form-group col-12 col-md-6">
                  ...
                  <input type='Number' className="form-control border-primary" Value={cost} readOnly />
                </div>
                <div className="form-group col-12 col-md-6">
                ...
                <div className="form-group col-12 col-md-6">
                  ...
                  <input type="text" className="form-control border-primary" Value={actionAt} readOnly />
                </div>
              </div>
