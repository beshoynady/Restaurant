          ...
          <div className="table-filter print-hide">
            <div className="col-12 text-dark d-flex flex-wrap align-items-center justify-content-evenly p-0 m-0">
              ...
              <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                ...
                <input type="text" className="form-control border-primary m-0 p-1 h-100" onChange={(e) => searchByitem(e.target.value)} />
              </div>

              <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                <label className="form-label text-wrap text-right fw-bolder p-0 m-0">نوع المخزن</label>
                <select className="form-control border-primary m-0 p-1 h-100" onChange={(e) => searchByCategory(e.target.value)} >
            ...
            <form onSubmit={(e) => createItem(e, employeeLoginInfo.id)}>
              ...
              <div className="modal-body p-4 text-right">
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">اسم الصنف</label>
                  <input type="text" className="form-control border-primary m-0 p-1 h-100" required onChange={(e) => setitemName(e.target.value)} />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">نوع المخزن</label>
                  <select className="form-control border-primary m-0 p-1 h-100"  name="category" id="category" form="carform" onChange={(e) => setcategoryId(e.target.value)}>
                ...
                <div className="form-group col-12 col-md-6">
                  ...
                  <input type='text' className="form-control border-primary m-0 p-1 h-100" required onChange={(e) => setlargeUnit(e.target.value)}></input>
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الوحدة الصغيره</label>
                  <input type='text' className="form-control border-primary m-0 p-1 h-100" required onChange={(e) => setsmallUnit(e.target.value)}></input>
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">رصيد افتتاحي</label>
                  <input type='Number' className="form-control border-primary m-0 p-1 h-100" required onChange={(e) => setcurrentBalance(e.target.value)} />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الحد الادني</label>
                  <input type='number' className="form-control border-primary m-0 p-1 h-100" required onChange={(e) => { setminThreshold(e.target.value); }} />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">السعر</label>
                  <input type='Number' className="form-control border-primary m-0 p-1 h-100" required onChange={(e) => { setprice(e.target.value) }} />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">عدد الوحدات</label>
                  <input type='Number' className="form-control border-primary m-0 p-1 h-100" required onChange={(e) => { setparts(e.target.value); setcostOfPart(price / e.target.value) }} />
                </div>
                <div className="form-group col-12 col-md-6">
                ...
                <div className="form-group col-12 col-md-6">
                  ...
                  <input type='text' className="form-control border-primary m-0 p-1 h-100" Value={new Date().toLocaleDateString()} required readOnly />
                </div>
              </div>
          ...
          <div className="modal-content shadow-lg border-0 rounded ">
            <form onSubmit={(e) => editStockItem(e, employeeLoginInfo.id)}>
              ...
              <div className="modal-body p-4 text-right">
                ...
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">رصيد افتتاحي</label>
                  <input type='Number' className="form-control border-primary m-0 p-1 h-100" defaultValue={currentBalance} required onChange={(e) => setcurrentBalance(e.target.value)} />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الحد الادني</label>
                ...
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">السعر</label>
                  <input type='Number' className="form-control border-primary m-0 p-1 h-100" defaultValue={price} required onChange={(e) => { setprice(e.target.value); setcostOfPart(e.target.value / Number(parts)) }} />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">عدد الوحدات</label>
                  <input type='Number' className="form-control border-primary m-0 p-1 h-100" defaultValue={parts} required onChange={(e) => { setparts(e.target.value); setcostOfPart(Number(price) / e.target.value) }} />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">تكلفة الوحده</label>
                  <input type='Number' className="form-control border-primary m-0 p-1 h-100" required defaultValue={costOfPart} readOnly />
