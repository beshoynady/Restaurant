...
const PayRoll = () => {
  ...
  return (
    <detacontext.Consumer>
      {
        ({setisLoadiog, EditPagination, employeeLoginInfo, endpagination, setstartpagination, setendpagination }) => {
          return (
                  ...
                  <div className="modal-content shadow-lg border-0 rounded ">
                    <form onSubmit={(e) => paidSalary(e, rollId)}>
                      ...
                      <div className="modal-footer d-flex flex-nowrap align-items-center justify-content-between m-0 p-1">
                        ...
                        <input type="submit" className="btn btn-danger col-6 h-100 px-2 py-3 m-0" value="تاكيد الدفع" />
                      </div>
                    </form>
                  </div>
                </div>
