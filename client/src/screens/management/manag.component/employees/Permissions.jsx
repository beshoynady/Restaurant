                    ...
                    <div className="d-flex flex-column text-dark">
                      <div className='d-flex'>
                        <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1" style={{ minWidth: '35%' }}>
                          ...
                          <input type="text" className="form-control border-primary" style={{ minWidth: '200px' }} onChange={(e) => getEmployeesByName(e.target.value)} />
                        ...
                        <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1" style={{ minWidth: '40%' }}>
                          ...
                          <select className="form-control border-primary"  style={{ minWidth: '200px' }} onChange={(e) => getEmployeesById(e.target.value)} >
                      ...
                      <div className='d-flex'>
                        <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1" style={{ minWidth: '35%' }}>
                          ...
                          <input type="text" className="form-control border-primary" style={{ minWidth: '200px' }} value={selectedEmployee ? selectedEmployee.fullname : ''} readOnly />
                        </div>

                        <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1" style={{ minWidth: '35%' }}>
                          <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الوظية</label>
                          <input type="text" className="form-control border-primary" style={{ minWidth: '200px' }} value={selectedEmployee ? selectedEmployee.role : ''} readOnly />
                        </div>
                      </div>
                    </div>
                  </div>
