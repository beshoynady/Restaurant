          ...
          <div className="table-filter print-hide">
            <div className="d-flex flex-wrap flex-row w-100 text-dark">
              ...
              <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                ...
                <select className="form-control border-primary m-0 h-100 "  onChange={(e) => getEmployeesByShift(e.target.value)} >
                  <option value="all">الكل</option>
              ...
              <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                ...
                <select className="form-control border-primary m-0 h-100 "  onChange={(e) => filterEmpByStatus(e.target.value)} >
                  <option value="all">الكل</option>
              ...
              <form className='text-right' onSubmit={(e) => createEmployee(e)}>
                ...
                <div className="modal-body p-4 text-right">
                  <div className="form-group col-12 col-md-6">
                    ...
                    <input type="text" id="fullname" className="form-control border-primary m-0 h-100 " required pattern="[A-Za-z\u0600-\u06FF\s]+" onChange={(e) => setfullname(e.target.value)} />
                  ...
                  <div className="form-group col-12 col-md-6">
                    ...
                    <input type="text" id="username" className="form-control border-primary m-0 h-100 " onChange={(e) => setusername(e.target.value)} />
                  </div>
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="phone">الموبايل</label>
                    <input type="text" id="phone" className="form-control border-primary m-0 h-100 " required pattern="[0-9]{11}" onChange={(e) => setphone(e.target.value)} />
                  ...
                  <div className="form-group col-12 col-md-6">
                    ...
                    <input type="text" id="password" className="form-control border-primary m-0 h-100 " required onChange={(e) => setpassword(e.target.value)} />
                  </div>
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="numberID">الرقم القومي</label>
                    <input type="text" id="numberID" className="form-control border-primary m-0 h-100 " required onChange={(e) => setnumberID(e.target.value)} />
                  </div>
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="email">الايميل</label>
                    <input type="email" id="email" className="form-control border-primary m-0 h-100 " required onChange={(e) => setemail(e.target.value)} />
                  ...
                  <div className="form-group col-12 col-md-6">
                    ...
                    <textarea id="address" className="form-control border-primary m-0 h-100 " required onChange={(e) => setaddress(e.target.value)}></textarea>
                  </div>
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="isActive">الحالة</label>
                    <select id="isActive" className="form-control border-primary m-0 h-100 " required onChange={(e) => setisActive(e.target.value)}>
                  ...
                  <div className="form-group col-12 col-md-6">
                    ...
                    <select id="shift" className="form-control border-primary m-0 h-100 " required onChange={(e) => setshift(e.target.value)}>
                      <option value="">اختر</option>
                      {shifts ? shifts.map((shift, i) =>
                        <option value={shift._id} key={i}>{shift.shiftType}</option>
                  ...
                  <div className="form-group col-12 col-md-6">
                    ...
                    <select id="role" className="form-control border-primary m-0 h-100 " required onChange={(e) => setrole(e.target.value)}>
                  ...
                  <div className="form-group col-12 col-md-6">
                    ...
                    <input type="number" id="workingDays" className="form-control border-primary m-0 h-100 " min={0} max={31} required onChange={(e) => setworkingDays(Number(e.target.value))} />
                  ...
                  <div className="form-group col-12 col-md-6">
                    ...
                    <input type="number" id="basicSalary" className="form-control border-primary m-0 h-100 " min={0} required onChange={(e) => setbasicSalary(Number(e.target.value))} />
                  ...
                  <div className="form-group col-12 col-md-6">
                    ...
                    <input type="number" id="taxRate" className="form-control border-primary m-0 h-100 " min={0} max={100} required onChange={(e) => settaxRate(Number(e.target.value))} />
                  ...
                  <div className="form-group col-12 col-md-6">
                    ...
                    <input type="number" id="insuranceRate" className="form-control border-primary m-0 h-100 " min={0} max={100} required onChange={(e) => setinsuranceRate(Number(e.target.value))} />
                  ...
                  {role === 'waiter' && (
                    <div className="form-group col-12 col-md-6">
                      ...
                      <input type="number" id="sectionNumber" className="form-control border-primary m-0 h-100 " required onChange={(e) => setsectionNumber(Number(e.target.value))} />
                    </div>
                  )}
                </div>
            ...
            <div className="modal-content shadow-lg border-0 rounded ">
              <form className='text-right' onSubmit={(e) => editEmployee(e)}>
                ...
                <div className="modal-body p-4 text-right">
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="fullname">الاسم</label>
                    <input type="text" id="fullname" className="form-control border-primary m-0 h-100 " defaultValue={fullname} required pattern="[A-Za-z\u0600-\u06FF\s]+" onChange={(e) => setfullname(e.target.value)} />
                    <div className="invalid-feedback">الرجاء إدخال اسم صحيح.</div>
                  </div>
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="username">اسم المستخدم</label>
                    <input type="text" id="username" className="form-control border-primary m-0 h-100 " defaultValue={username} required onChange={(e) => setusername(e.target.value)} />
                  </div>
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="phone">الموبايل</label>
                    <input type="text" id="phone" className="form-control border-primary m-0 h-100 " defaultValue={phone} required pattern="[0-9]{11}" onChange={(e) => setphone(e.target.value)} />
                    <div className="invalid-feedback">الرجاء إدخال رقم هاتف صحيح (11 رقم).</div>
                  </div>
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="password">الباسورد</label>
                    <input type="password" id="password" className="form-control border-primary m-0 h-100 " onChange={(e) => setpassword(e.target.value)} />
                  </div>
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="numberID">الرقم القومي</label>
                    <input type="text" id="numberID" className="form-control border-primary m-0 h-100 " defaultValue={numberID} required onChange={(e) => setnumberID(e.target.value)} />
                  </div>
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="email">الايميل</label>
                    <input type="email" id="email" className="form-control border-primary m-0 h-100 " defaultValue={email} required onChange={(e) => setemail(e.target.value)} />
                    <div className="invalid-feedback">الرجاء إدخال عنوان بريد إلكتروني صحيح.</div>
                  </div>
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="address">العنوان</label>
                    <textarea id="address" className="form-control border-primary m-0 h-100 " defaultValue={address} required onChange={(e) => setaddress(e.target.value)}></textarea>
                  </div>
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="isActive">في الفريق</label>
                    <select id="isActive" className="form-control border-primary m-0 h-100 " defaultValue={isAdmin} required onChange={(e) => setisAdmin(e.target.value)}>
                  ...
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="isActive">الحالة</label>
                    <select id="isActive" className="form-control border-primary m-0 h-100 " defaultValue={isActive} required onChange={(e) => setisActive(e.target.value)}>
                      <option value={true}>متاح</option>
                      <option value={false}>ليس متاح</option>
                    </select>
                  </div>
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="shift">الشيفت</label>
                    <select id="shift" className="form-control border-primary m-0 h-100 " defaultValue={shift} required onChange={(e) => setshift(e.target.value)}>
                      {shifts ? shifts.map((shift, i) =>
                        <option value={shift._id} key={i}>{shift.shiftType}</option>
                      ) : <option>لم يتم إنشاء شفتات</option>}
                    </select>
                  ...
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="role">الوظيفة</label>
                    <select id="role" className="form-control border-primary m-0 h-100 " defaultValue={role} required onChange={(e) => setrole(e.target.value)}>
                      <option value="owner">مالك</option>
                      <option value="manager">مدير</option>
                      <option value="cashier">كاشير</option>
                      <option value="deliveryman">الديلفري</option>
                  ...
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="workingDays">ايام العمل الشهرية</label>
                    <input type="number" id="workingDays" className="form-control border-primary m-0 h-100 " defaultValue={workingDays} min={0} max={31} required onChange={(e) => setworkingDays(Number(e.target.value))} />
                    <div className="invalid-feedback">الرجاء إدخال أيام عمل صحيحة.</div>
                  </div>
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="basicSalary">المرتب الأساسي</label>
                    <input type="number" id="basicSalary" className="form-control border-primary m-0 h-100 " defaultValue={basicSalary} min={0} required onChange={(e) => setbasicSalary(e.target.value)} />
                    <div className="invalid-feedback">الرجاء إدخال راتب صحيح.</div>
                  </div>
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="taxRate">نسبة الضريبة</label>
                  ...
                  {role === 'waiter' && (
                    <div className="form-group col-12 col-md-6">
                      <label className="form-label text-wrap text-right fw-bolder p-0 m-0" htmlFor="sectionNumber">رقم السكشن</label>
                      <input type="number" id="sectionNumber" className="form-control border-primary m-0 h-100 " defaultValue={sectionNumber} required onChange={(e) => setsectionNumber(Number(e.target.value))} />
                    </div>
                  )}
                </div>
                <div className="modal-footer flex-nowrap d-flex flex-row align-items-center justify-content-between">
