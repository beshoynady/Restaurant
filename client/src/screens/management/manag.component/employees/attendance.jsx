          ...
          <div className="table-filter w-100">
            <div className="w-100 d-flex flex-row flex-wrap align-items-center justify-content-start text-dark">
              ...
              <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                ...
                <select className="form-control border-primary m-0 p-1 h-100"  onChange={(e) => searchByStatus(e.target.value)}>
              ...
              <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                ...
                <select className="form-control border-primary m-0 p-1 h-100"  onChange={(e) => getRecordsByShift(e.target.value)} >
                  <option value="all">الكل</option>
              ...
              <div className='col-12 d-flex align-items-center justify-content-between'>
                <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                  ...
                  <select className="form-control border-primary m-0 p-1 h-100"  onChange={(e) => setallAttendanceRecords(filterByTime(e.target.value, allAttendanceRecords))}>
            ...
            <form onSubmit={editAttendanceRecord}>
              ...
              <div className="modal-body p-4 text-right">
                <div className="d-flex flex-wrap align-items-center justify-content-between">
                  ...
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الاسم</label>
                    <input type="text" className="form-control border-primary m-0 p-1 h-100" readOnly defaultValue={recordToUpdate?.employee?.fullname || ''} />
                  </div>
                  <div className="form-group col-12 col-md-6">
                    <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الشيفت</label>
                    <input
