          ...
          <div className="table-filter print-hide">
            <div className="col-12 text-dark d-flex flex-wrap align-items-center justify-content-evenly p-0 m-0">
              ...
              {/* <div className="form-group w-100 h-auto px-3 d-flex align-itmes-center justify-content-start col-12  col-12 col-md-6 ">
                        ...
                        <select className="form-control border-primary m-0 p-1 h-100"  name="category" id="category" form="carform" onChange={(e) => filterByStatus(e.target.value)}>
              ...
              <div className='col-12 d-flex align-items-center justify-content-between flex-wrap'>
                <div className="filter-group d-flex align-items-center justify-content-between col-md-4 col-sm-12 p-0 mb-2">
                  ...
                  <select className="form-control border-primary m-0 p-1 h-100"  onChange={(e) => setallReservations(filterByTime(e.target.value, allReservations))}>
                    <option value="">اختر</option>
                  ...
                  if (i >= startpagination & i < endpagination) {
                    return (
                      <tr key={i}>
                        ...
                        <td>
                          <select className="form-control border-primary m-0 p-1 h-100"  name="status" id="status" onChange={(e) => confirmReservation(reservation._id, e.target.value)}>
