                      ...
                      {listOrderShow.length > 0 ?
                        listOrderShow.slice(startpagination, endpagination + 15).map((recent, i) => (
                          <tr key={i} className={
                            ...
                            <td>
                              <select className="form-control border-primary m-0 h-100 "  name="status" 
          ...
          <div className="modal-content shadow-lg border-0 rounded ">
            <form>
              ...
              <div className="modal-footer d-flex flex-nowrap align-items-center justify-content-between m-0 p-1">
                ...
                <input type="submit" className=" btn btn-success col-6 h-100 p-0 m-0" value="Print" onClick={handlePrintInvoiceSplit} />
              </div>
            </form>
          </div>
        </div>
          ...
          <div className="modal-content shadow-lg border-0 rounded ">
            <form>
              ...
              <div className="modal-footer d-flex flex-nowrap align-items-center justify-content-between m-0 p-1">
                ...
                <input type="button" className=" btn btn-success col-6 h-100 p-0 m-0" value="تم الموافقه" onClick={(e) => isPrint ? aproveOrder(e, employeeLoginInfo.id) : alert("لم تتم الطباعه ! يجب طباعه اولا")} />
              </div>
            </form>
          </div>
        </div>
