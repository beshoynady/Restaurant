          ...
          <div class="table-filter print-hide">
            <div class="col-12 text-dark d-flex flex-wrap align-items-center justify-content-evenly p-0 m-0">
              ...
              <div class="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                ...
                <select class="form-control border-primary" onChange={(e) => filterByType(e.target.value)} >
              ...
              <div class="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                ...
                <select class="form-control border-primary" onChange={(e) => filterByCashRegisters(e.target.value)} >
                  <option value={""}>الكل</option>
              ...
              <div className='col-12 d-flex align-items-center justify-content-between'>
                <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                  ...
                  <select className="form-control border-primary"  onChange={(e) => setAllCashMovement(filterByTime(e.target.value, AllCashMovement))}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="modal-body p-4 text-right">
                ...
                <div className="form-group col-12 col-md-6">
                  ...
                  <input type='text' className="form-control border-primary" Value={CashRegisterBalance} readOnly />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">المبلغ</label>
                  <input type='text' className="form-control border-primary" required onChange={(e) => setAmount(parseFloat(e.target.value))} />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الوصف</label>
                  <textarea className="form-control border-primary" onChange={(e) => setDescription(e.target.value)}
                    required />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">التاريخ</label>
                  <input type="text" className="form-control border-primary" value={formatDate(new Date())} readOnly />
                </div>
              </div>
          ...
          <div className="modal-content shadow-lg border-0 rounded ">
            <form onSubmit={handleSubmit}>
              ...
              <div className="modal-body p-4 text-right">
                ...
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الوصف</label>
                  <textarea rows="2" cols="80" className="form-control border-primary" onChange={(e) => setDescription(e.target.value)} required />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">التاريخ</label>
                  <input type="text" className="form-control border-primary" Value={formatDate(new Date())} readOnly />
          ...
          <div className="modal-content shadow-lg border-0 rounded ">
            <form onSubmit={transferCash}>
              ...
              <div className="modal-body p-4 text-right">
                <div className="form-group col-12 col-md-6" >
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الخزينه </label>
                  <select className="form-control border-primary"  onChange={(e) => { selectCashRegister(e.target.value); setsendRegister(e.target.value) }} >
                    {employeeCashRegisters.map(cashRegister => {
                      return <option value={cashRegister._id}>{cashRegister.name}</option>;
                    })}
                  </select>
                ...
                <div className="form-group col-12 col-md-6">
                  ...
                  <select className="form-control border-primary"  onChange={(e) => setreceivRegister(e.target.value)}>
                    <option value={""}>اختر</option>
