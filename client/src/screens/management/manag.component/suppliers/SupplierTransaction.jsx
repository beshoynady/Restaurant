            ...
            <div className="col-12 text-dark d-flex flex-wrap align-items-center justify-content-evenly p-0 m-0">
              ...
              <div className='col-12 d-flex align-items-center justify-content-between'>
                <div className="filter-group d-flex align-items-center justify-content-between col-3 p-0 mb-1">
                  ...
                  <select className="form-control border-primary"  onChange={(e) => setAllSupplierTransaction(filterByTime(e.target.value, AllSupplierTransaction))}>
            ...
            <form onSubmit={handleAddSupplierTransaction}>
              ...
              <div className="modal-body p-4 text-right">
                <div className="form-group col-12 col-md-6">
                  ...
                  <input type="date" className="form-control border-primary" value={transactionDate} onChange={(e) => setTransactionDate(e.target.value)} />
                </div>
                <div className="form-group col-12 col-md-6">
                ...
                <div className="form-group col-12 col-md-6">
                  ...
                  <select required className="form-control border-primary"  id="supplierSelect" onChange={(e) => setTransactionType(e.target.value)}>
                ...
                <div className="form-group col-12 col-md-6">
                  ...
                  <select required className="form-control border-primary"  id="supplierSelect" onChange={(e) => setInvoiceNumber(e.target.value)} >
                    <option>اختر رقم الفاتورة</option>
                ...
                <div className="form-group col-12 col-md-6">
                  ...
                  <input type="number" className="form-control border-primary" defaultValue={amount} onChange={(e) => handlecurrentBalance(e.target.value)} />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الرصيد السابق</label>
                  <input type="text" className="form-control border-primary" value={previousBalance} readOnly />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">الرصيد الحالي</label>
                  <input type="text" className="form-control border-primary" value={currentBalance} readOnly />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">طريقة الدفع</label>
                  <input type="text" className="form-control border-primary" defaultValue={paymentMethod} onChange={(e) => setPaymentMethod(e.target.value)} />
                </div>
                <div className="form-group col-12 col-md-6">
                  <label className="form-label text-wrap text-right fw-bolder p-0 m-0">ملاحظات</label>
                  <input type="text" className="form-control border-primary" value={notes} onChange={(e) => setNotes(e.target.value)} />
                </div>
              </div>
                    ...
                    <form onSubmit={(e) => editStockItem(e, employeeLoginInfo.id)}>
                      ...
                      <div className="modal-body p-4 text-right">
                        ...
                        <div className="form-group col-12 col-md-6">
                          ...
                          <input type='Number' className="form-control border-primary" defaultValue={Balance} required onChange={(e) => setBalance(e.target.value)} />
                        </div>
                        <div className="form-group col-12 col-md-6">
                        ...
                        <div className="form-group col-12 col-md-6">
                          ...
                          <input type='Number' className="form-control border-primary" defaultValue={price} required onChange={(e) => { setprice(e.target.value); settotalCost(e.target.value * Balance) }} />
                        </div>
                        <div className="form-group col-12 col-md-6">
                          <label className="form-label text-wrap text-right fw-bolder p-0 m-0">التكلفة</label>
                          <input type='text' className="form-control border-primary" required defaultValue={totalCost} readOnly />
                        </div>
                        <div className="form-group col-12 col-md-6">
                          <label className="form-label text-wrap text-right fw-bolder p-0 m-0">عدد الوحدات</label>
                          <input type='Number' className="form-control border-primary" defaultValue={parts} required onChange={(e) => { setparts(e.target.value); setcostOfPart(price / e.target.value) }} />
                        </div>
                        <div className="form-group col-12 col-md-6">
