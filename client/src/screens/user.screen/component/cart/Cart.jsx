          ...
          <div className="cart-inner">
                        ...
                        <div className="col-9">
                          <div className="card-body d-flex flex-column align-items-stretch  justify-content-start" style={{ padding: '4px' }}>
                            <div className="d-flex  justify-content-between w-100">
                              ...
                              <button className="h-100 btn btn-danger btn-sm" onClick={() => deleteItemFromCart(item.productid, item.sizeId)}>حذف</button>
                            </div>
            ...
            <div className="invoice side" >
              <div ref={printContainer} className="max-w-400px p-1 mb-7 printpage" style={{ Width: '100%', height: "80%", textAlign: 'center', overflowY: 'auto', overflowX: 'hidden', fontWeight:'700' }}>
                ...
                <table className="table table-bordered table-responsive-md" style={{ direction: 'rtl' }}>
                  ...
                  <tfoot>
                    ...
                    {myOrder.orderType === 'Delivery' && myOrder.deliveryCost > 0 && (
                      <tr>
                    ...
                    {myOrder.orderType === 'Internal' && restaurantData.serviceTaxRate > 0 && (
                      <tr>
              ...
              <div className="total-order p-1 d-flex align-items-center     justify-content-between mt-3">
                {id ? (
                  <button className='total-order-h-100 btn btn btn-success' onClick={(e) => checkout(e, myOrder._id)}>طلب الحساب</button>
                ) : null}
                <button className='total-order-h-100 btn btn btn-info' onClick={handlePrint}>طباعه</button>
              </div>
