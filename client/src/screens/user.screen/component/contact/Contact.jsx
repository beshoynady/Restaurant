              ...
              <div className="container">
                ...
                <div className='contact-content'>
                  <div className="right">
                    ...
                    <p>موبايل
                      <a href={`tel:${restaurantData.contact?.phone}`}>{restaurantData.contact?.phone}</a>
                    </p>
                  </div>
                  <div className="left">
                    <h2>لارسال الشكاوي و الملاحظات</h2>
                    <form onSubmit={sendmessage}>
                      <input placeholder='اسمك' type="text" id='name' required onChange={(e) => setName(e.target.value)} />
                      <input placeholder='البريد الالكتروني' type="email" id='email' onChange={(e) => setEmail(e.target.value)} />
                      <input placeholder='رقم الموبايل' type="tel" id='phone' required onChange={(e) => setPhone(e.target.value)} />
                      <textarea placeholder='رسالتك' maxLength={150} type="text" id='subject' required onChange={(e) => setMessage(e.target.value)} />
