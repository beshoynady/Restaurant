        ...
        <form className="w-100 text-white text-right" style={{ fontSize: '20px', fontWeight: '800' }}
          ...
          <div className="d-flex flex-wrap align-items-center justify-content-between">
            <div className="col-md-8 mb-1">
              ...
              <input type="text" className="form-control border-primary m-0 h-100 " id="name" onChange={(e) => setCustomerName(e.target.value)} />
            </div>
            <div className="col-md-4 mb-1">
              <label htmlFor="mobile" className="form-label text-wrap text-right fw-bolder p-0 m-0">رقم الموبايل</label>
              <input type="tel" className="form-control border-primary m-0 h-100 " id="mobile" onChange={(e) => setCustomerPhone(e.target.value)} />
            </div>
          </div>
          ...
          <div className="row mb-1">
            <div className="col-md-7">
              ...
              <select className="form-control border-primary m-0 h-100 " id="tableNumber" onChange={(e) => setTableInfo({ id: e.target.value, tableNumber: e.target.options[e.target.selectedIndex].text })}>
            ...
            <div className="col-md-5">
              ...
              <input type="number" className="form-control border-primary m-0 h-100 " id="numberOfGuests" onChange={(e) => setNumberOfGuests(e.target.value)} />
            </div>
          </div>
          <div className="mb-1">
            <label htmlFor="notes" className="form-label text-wrap text-right fw-bolder p-0 m-0">ملاحظات</label>
            <textarea className="form-control border-primary m-0 h-100 " id="notes" rows="2" onChange={(e) => setReservationNote(e.target.value)}></textarea>
          </div>
